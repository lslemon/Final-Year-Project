...
HD_PWD='C:/Users/lukes/Documents/Final_Year_Project/Architecture/FFT_axi/vhdl/xilinxprj/project_1.runs/system_design_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_design_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_design_xfft_0_0.tcl
