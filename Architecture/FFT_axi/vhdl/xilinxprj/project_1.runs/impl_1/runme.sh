...
HD_PWD='C:/Users/lukes/Documents/Final_Year_Project/Architecture/FFT_axi/vhdl/xilinxprj/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_design_wrapper.tcl -notrace
